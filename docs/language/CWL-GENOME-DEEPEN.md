...
**Tip start:** **1.0.18** (RFC-0025) · **current:** **1.0.39**  
...
| **Repeated markup** | `repeat … as … html` (`40`, RFC-0031) — done (`1.0.31`); item fields (`41`) — done (`1.0.32`); conditional `if item.field` (`47`) — done (`1.0.39`) |
