...
**Tip start:** **1.0.18** (RFC-0025) · **current:** **1.0.50**  
...
| **Repeated markup** | `repeat … as … html` (`40`, RFC-0031) — done (`1.0.31`); item fields (`41`) — done (`1.0.32`); conditional `if item.field` (`47`) — done (`1.0.39`); empty `else html` (`48`) — done (`1.0.40`); one-level nest (`49`) — done (`1.0.41`); nest+`if`/`else` composition (`50`) — done (`1.0.42`, gene closed) |
