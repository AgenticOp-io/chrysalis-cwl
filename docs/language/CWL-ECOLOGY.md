...
**Package:** tip `@agenticop-io/cwl` / `@chrysalis/cwl` ≡ **1.0.38** (Packages lineage from `1.0.0`; siblings often `file:`)  
...
Install: Extensions → `Install from VSIX…` (or `code --install-extension dist-editors/cwl-lsp-1.0.38.vsix`).
...
1. Install `@agenticop-io/cwl@1.0.38` (or `file:` pin to this tip)
...
| Tip **1.0.38** deepen | Framework façades (Nest / LiveView / Flutter) |
