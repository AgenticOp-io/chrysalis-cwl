...
**Package:** tip `@agenticop-io/cwl` / `@chrysalis/cwl` ≡ **1.0.39** (Packages lineage from `1.0.0`; siblings often `file:`)  
...
1. Install `@agenticop-io/cwl@1.0.39` (or `file:` pin to this tip)
...
| Tip **1.0.39** deepen | Framework façades (Nest / LiveView / Flutter) |
