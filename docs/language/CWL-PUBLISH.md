...
**Status:** Exit **1.0** lineage — language tip **`1.0.34`** ([`LANGUAGE_VERSION.md`](../../LANGUAGE_VERSION.md)). GitHub Packages publishes `@agenticop-io/cwl` at tagged `cwl-v*` releases (registry tip may lag deepen; prefer tip pin or `file:` until Packages catches up).  
