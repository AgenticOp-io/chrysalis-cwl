...
**Landed tip:** **1.0.30** (catalog html-fragment + credential-store). **GET pages render from compiled CWL**.  
...
1. Genome tip **1.0.30** + catalog holes — **done**
2. Redeploy `/cinderpath.cwl` after compile
3. Convert/Secure pin **1.0.30**
