...
**Status:** **Complete (CWL-owned)** as of **`1.0.3`** (2026-08-09); tip polish **`1.0.15`**  
**Tip:** `@chrysalis/cwl@1.0.15` / published lineage `@agenticop-io/cwl@1.0.0`… (tag `cwl-v*` for tip)  
...
| **Secure** | Pin tip `1.0.15`; apply multi-host profile at cutover; fill `dna_gaps` |
