...
**Branch / SHA:** `candidate/wptp-convert-orbit` · **`600b3f39`** (whole-system gate) · prior map **`4e997b6c`**  
**CWL tip still consumed:** **`1.0.17`** (`file:` junctions + pin smoke)  
**Related:** [CONVERT-GRAVITY-REQUESTED.md](./CONVERT-GRAVITY-REQUESTED.md) (**Done**) · [DNA-BUILD-NEXT.md](./DNA-BUILD-NEXT.md) · Convert [`docs/CONVERT-WHOLE-SYSTEM.md`](../../../chrysalis-convert/docs/CONVERT-WHOLE-SYSTEM.md) · [`docs/WPTP-CONVERT-ORBIT.md`](../../../chrysalis-convert/docs/WPTP-CONVERT-ORBIT.md)
...
None required for DNA invent. Optional hygiene for a CWL agent / orchestrator:
...
3. If Secure still pins `<1.0.17`, that remains Secure’s tip hygiene ([SECURE-CUTOVER-REQUESTED.md](./SECURE-CUTOVER-REQUESTED.md))

## Convert reply shape (already met)
...
Dual primary (COBOL residual **or** one dialect deepen), Hub peels feeding CWL, registry pin when ready — not new CWL genes unless a contract hole appears.
