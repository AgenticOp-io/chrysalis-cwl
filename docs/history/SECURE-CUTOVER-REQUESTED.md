...
**From:** CWL pillar (`chrysalis-cwl` @ **`1.0.0`** — `@agenticop-io/cwl` published)  
...
**Related:** [DNA-EVOLUTION-0.1.9.md](./DNA-EVOLUTION-0.1.9.md) Step G · [RFC-0022](../language/CWL-RFC-0022-dna-surface-bridge.md) · [RFC-0023](../language/CWL-RFC-0023-deploy-dna-profiles.md) · [PRIVATE-PILLARS.md](./PRIVATE-PILLARS.md) · [EXIT-1.0.md](./EXIT-1.0.md)

## Ask (one sentence)

Make Helix cutover’s **default** compare live `app-dna-v1` against the authored CWL surface per RFC-0022/0023 — consume CWL fixtures/seed tools, **pin `@agenticop-io/cwl@1.0.0`**, never fork the grammar.
...
3. **No grammar fork** — Do not copy or alter CWL parser/print into Helix. Import sibling / `file:` / registry `@agenticop-io/cwl@1.0.0` / `CHRYSALIS_CWL_ROOT` only.
...
5. **Private repo** — Work in private `AgenticOp-io/chrysalis-security`; pin GitHub Packages (not public npm).
...
- [ ] Pin `@agenticop-io/cwl@1.0.0` (or `file:` ≡ `1.0.0`); `npm run cwl-bridge-smoke` green
